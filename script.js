...
function speakThis(message) {
    ...
    else if(message.includes('Introduce your Admin') || message.includes('Introduce Aayush') || message.includes('Introduce Aayush Baral') || message.includes('About Aayush Baral')) {
